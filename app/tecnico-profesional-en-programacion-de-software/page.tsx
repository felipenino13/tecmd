        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2">
            <div className="grid gap-y-4">
                <div>
                    ...
                    <p className="text-base">Desarrolla código, resuelve problemas y lidera en la transformación social a través del software</p>
                </div>
                <div className="flex gap-2">
                    <p className="text-sm rounded-xl px-2 py-1 border border-white">4 Periodos académicos</p>
                    <p className="text-sm rounded-xl px-2 py-1 border border-white">65 Créditos</p>
                    <p className="text-sm rounded-xl px-2 py-1 border border-white">100% Virtual</p>
                </div>
                <p>
